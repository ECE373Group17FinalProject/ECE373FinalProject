...
public class VolunteerGUI extends JFrame {
	...
	{	//creats Volunteer homePage menu bar
		...
		editEvents = new JMenuItem ("Edit Your Events" );
		changeLoc = new JMenuItem("Change Your Location");
		logOut = new JMenuItem ("Log Out" );
	
		
		editEvents.addActionListener(new MenuListener());	
		...
		manageAccountMenu.add(editEvents);
	...
	private class MenuListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			else if(source.equals(editEvents))
			{
				handleEditBio();
			}
...
//			      SearchGUI newSearchEngineGUI = new SearchEngineGUI("Results",vol,workType.getSelectedIndex(),shiftsStart.getSelectedIndex(),
//			    		  shiftsEnd.getSelectedIndex(),day,cshO );
			}
